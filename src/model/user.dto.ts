...
export class UserDto {
  ...
  @ApiProperty({
    ...
    description: 'Magic link token for email verification',
    required: false,
  })
  ...
  @ApiProperty({
    ...
    description: 'Magic link expiry timestamp',
    required: false,
  })
  ...
  @ApiProperty({
    example: '123456',
    description: 'OTP for mobile verification',
    required: false,
  })
  otp?: string;
  ...
  @ApiProperty({
    example: { google: 'google-id', facebook: 'facebook-id' },
    description: 'Social accounts for paid users',
    required: false,
    type: Object,
  })
